...
namespace ChangeMp3
{
    class Program
    {
        ...
        const string TargetStringToBeDeleted = "au_gb23winter_1083210801_";
        const string TargetStringToBeAdded = "";
        const string RadioProgramName = "杉田敏_08_2023冬";
        ...
        static void Main(string[] args)
        {
            ...
            foreach (string arg in args)
            {
                ...
                {
                    newFileNameWithoutExtension = TargetStringToBeAdded + splitted[1];
